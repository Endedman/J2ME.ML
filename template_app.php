...
$id=$_GET['id'];
$rows = "SELECT * FROM apps WHERE id='$id'";
					...
					<tr>
										...
										<tbody>
											<tr>
												<td class="doc-banner-title-container">
													<h1 class="doc-banner-title"><? print ($row["app_name"]); ?></h1>
													<a href="#" class="doc-header-link"><? print ($row["dev_name"]); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
											...
											<tr>
												...
												<td class='doc-details-ratings-price' style='width: 222px;''>
													<div style='display: flex;'>
														...
														</div><div class='goog-inline-block counter'>$row[votes]</div>
													</div>
													<div class='buy-wrapper-container'>
														<div class='buy-wrapper  buy-button-large'>
															<div class='buy-border'>
																<a class='buy-link buy-button goog-inline-block' href='http://donationalerts.com/r/$row[paytoken]'>
																	<span class='buy-button-price'>Установить<sup>Paid$$row[fee]</sup></span>
											...
											<tr>
												...
												<td class='doc-details-ratings-price' style='width: 222px;''>
													...
													<div class='buy-wrapper-container'>
														<div class='buy-wrapper  buy-button-large'>
															<div class='buy-border'>
																<a class='buy-link buy-button goog-inline-block' href='$row[file]'>
						...
						<td style="height: 348px;">
							<div class="doc-banner-image-container">
								<img src="<? print ($row["banner"]); ?>" alt="<? print ($row["app_name"]); ?>" width="705">
							</div>
						</td>
					</tr>
				</tbody>
