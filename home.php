...
<body>
	<div class="headbar">
		...
		<div class="head_doact">
			<ol class="headlist">
				<li class="headlinks">
					<a class="headlink" id="headlink_1" href="console.php">
						<span class="headlink_sup"></span>
						<div class="head_nopad">
							<span class="headlink_context bold">Консоль</span>
						</div>
					</a>
				</li>
				<li class="headlinks">
...
<!-- 			<a href="http://j2me.ml/" class="play-inline-block">
			...
			<div class="search">
				<div class="search-container">
					<form action="search.php" method="get" id="search-box" class="search-type">
									...
									<div class="carousel-pages">
										<div class="carousel-pages-wrapper" data-analyticsid="featured-apps">
											<div class="carousel-page">
												<div class='j2me-inline-block' style='display: flex; flex-direction: row; flex-wrap: wrap;'>
												<?php
												$rows = "SELECT * FROM apps where paid='false'";
												...
												<div class='j2me-inline-block' style='display: flex; flex-direction: row; flex-wrap: wrap;'>
												<?php
												$rows_paid = "SELECT * FROM apps where paid='true'";
												
												$d_paid = mysqli_query($link, $rows_paid);
												// $row = mysqli_fetch_array($d, MYSQLI_ASSOC);
												while($row_paid=mysqli_fetch_array($d_paid))
													{	
														echo "
														
															<div class='snippet snippet-tall'>
																<div class='thumbnail-wrapper j2me-inline-block'>
																	<a href='http://j2me.ml/?id=$row_paid[id]' class='thumbnail'>
																		<img src=$row_paid[icon] alt=$row_paid[app_name]>
																	</a>
																</div>
																<div class='details'>
																	<a class='title' title='$row_paid[app_name]' href='http://j2me.ml/?id=1'>$row_paid[app_name]</a>
																	<span class='attribution'>
																		<a href='http://j2me.ml/?dev=$row_paid[id]'>$row_paid[dev_name]</a>
																	</span>
																</div>
																<div class='buy-wrapper j2me-inline-block'>
																	<div class='buy-border'>
																		<a class='buy-link buy-button j2me-inline-block' href='/?id=$row_paid[id]'>
																			<span class='buy-button-price' id='mobi.opera.mobi'>Pay $$row_paid[fee]</span>
																		</a>
																</div>
																</div>
															</div>
	...
	<div id="footer">
		<a class="footer-link" href="console.php">Консоль разработчика</a>|
		<a class="footer-link">
